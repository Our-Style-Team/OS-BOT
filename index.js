...
client.on('ready', () => {
  ...
  setInterval(() => {
    client.user.setActivity("Watch Montages Press here", { type: "STREAMING", url: "https://www.youtube.com/watch?v=KV-8PCeqPzg" });
  }, 10000)
...
client.on('ready', async () => {
  ...
  client.guilds.cache.get('535515917518372884').channels.cache.get('736380370651709531').messages.fetch('866380703762350091'); client.guilds.cache.get('535515917518372884').channels.cache.get('736380370651709531').messages.fetch('867423471507341323');
    ...
    if (emoji.name == '🟦') {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('615317792677298192')
    ...
    if (emoji.name == '🟨') {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('615317793159512074')
          member.roles.add('731432571073986561')
        }
      })
    }
    ...
    if (emoji.name == '🟧') {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('615317792756858895')
          member.roles.add('731432571073986561')
        }
      })
    }
    ...
    if (emoji.name == '⬛') {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('615317792664715306')
          member.roles.add('731432571073986561')
        }
      })
    }
    ...
    if (emoji.name == '🦑') {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('615317792723304488')
          member.roles.add('731432571073986561')
        }
      })
    }
    ...
    if (emoji.id == mc) {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('731528298445668442')
          member.roles.add('731528037291524158')
          member.roles.add('817726951962705930')
        }
      })
    ...
    if (emoji.id == among) {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('812452159773343765')
          member.roles.add('731528037291524158')
          member.roles.add('817726951962705930')
        }
      })
    ...
    if (emoji.id == rocket) {
      ...
      message.guild.members.fetch(user.id).then(member => {
        if (user.bot) return;
          ...
          member.roles.add('759441333584265247')
          member.roles.add('731528037291524158')
          member.roles.add('817726951962705930')
        }
      })
...
client.on('message', message => {
  if (message.content === '!birthday') {
    const embed = new Discord.MessageEmbed()
      ...
      .addField('\n JustTygo', 'February 17', false)
      .addField('\n Styleken', 'April 24', false)
      .addField('\n DanzoDon', 'June 1', false)
      .addField('\n Erol', 'June 7', false)
      .addField('\n Kiritoo', 'June 20', false)
      ...
      .addField('\n Klein', 'August 30 ', false)
      .addField('\n jimm25', 'September 30', false)
      .addField('\n jinleehurb', 'October 23', false)
      .addField('\n Kevin1185', 'November 2', false)
      .addField('\n LordCroissant', 'November 12', false)
      .addField('\n Pipnocho', 'November 19', false)
      .addField('\n Junusbiaz', 'December 3', false)
      .setFooter('Clan birthday is December 11 2019 ', 'https://i.pinimg.com/originals/8b/de/81/8bde81e36644c034efbbd3c57a474847.png')
...
client.on('ready', () => {
  ...
  var text12chennelhaha = client.channels.cache.find(channel => channel.id === '828290378695311360')
  ...
  client.on('message', message => {
    if (message.content === 'Date is 1/20/2023') {
      text12chennelhaha.send("Happy birthday <@482162074097549333>")// Astru
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 2/16/2023') {
      text12chennelhaha.send("Happy birthday <@499591499122737153>")// JustTygo
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 4/23/2023') {
      text12chennelhaha.send("Happy birthday <@499591499122737153>")// Styleken
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 5/31/2022') {
      text12chennelhaha.send("Happy birthday <@320264452874305536>")// Danzo
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 6/6/2022') {
      text12chennelhaha.send("Happy birthday <@363391047365165058>")// Erol
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 6/20/2022') {
      text12chennelhaha.send("Happy birthday <@805879974363791420>")// Kiritoo
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 6/22/2022') {
      text12chennelhaha.send("Happy birthday <@321188857359892480>")// Glaedr
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 8/2/2022') {
      text12chennelhaha.send("Happy birthday <@456100864738983957>")// CTNS
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 8/4/2022') {
      text12chennelhaha.send("Happy birthday <@666455281596891149>")// Sanmaay
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 8/9/2022') {
      text12chennelhaha.send("Happy birthday <@727301310461771797>")// Pentane
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 8/11/2022') {
      text12chennelhaha.send("Happy birthday <@364069557951922176>")// Otmanezza
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 8/13/2022') {
      text12chennelhaha.send("Happy birthday <@505751422449614878>")// Kenshiro
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 8/29/2022') {
      text12chennelhaha.send("Happy birthday <@567395420976709652>")// Klein
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 9/29/2022') {
      text12chennelhaha.send("Happy birthday <@286209333488910336>")// Jimm25
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 10/22/2022') {
      text12chennelhaha.send("Happy birthday <@504543749293080597>")// Jinleehurb
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 11/1/2022') {
      text12chennelhaha.send("Happy birthday <@286208201186213888>")// Kevin1185
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 11/11/2022') {
      text12chennelhaha.send("Happy birthday <@314532481519058944>")// Lordcroissant
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 11/18/2022') {
      text12chennelhaha.send("Happy birthday <@314532481519058944>")// Pipnocho
    }
  })
  client.on('message', message => {
    if (message.content === 'Date is 12/2/2022') {
      text12chennelhaha.send("Happy birthday <@423131212945817620>")// Junusbiaz
    }
  })
...
client.on('message', message => {
  if (message.content === '!our style') {
    const embed = new Discord.MessageEmbed()
      ...
      .setTitle('Our Style Members')
      .setColor(0xc44312)
      .setDescription('The Our Style Legends :')
      .addField('Astru®', 'EU', true)
      .addField('beeri12h', 'NA', true)
      .addField('CTNS', 'EU', true)
      .addField('CubeX', 'EU', true)
      .addField('DanzoDon', 'JPN', true)
      .addField('DraKo', 'NA', true)
      .addField('Erol', 'EU', true)
      .addField('Glaedr', 'EU', true)
      .addField('Jimm25', 'EU', true)
      .addField('jinleehurb', 'EU', true)
      .addField('JunusBiaz', 'EU', true)
      .addField('JustTygo', 'EU', true)
      .addField('Kenshiro', 'EU', true)
      .addField('Keraunos', 'EU', true)
      .addField('Kevin1185', 'EU', true)
      .addField('Kiritoo', 'EU', true)
      .addField('Klein', 'EU', true)
      .addField('LordCroissant', 'EU', true)
      .addField('Marshie', 'NA', true)
      .addField('Pentane', 'EU', true)
      .addField('Pipnocho', 'EU', true)
      .addField('Sanmaay', 'EU', true)
      .addField('Styleken', 'EU', true)
      .addField('Yeakoo', 'NA', true)
    message.channel.send(embed)
  }
})
...
////////////////////////////////////////////////////////////////////////////
// client.on('message', async message => {
//   if(message.content === "!osbb") {

// var embed = new Discord.MessageEmbed()
//   .setColor('#8CD7FF')
//   .setTitle(`Our Style Balling`)
//   .setDescription("Can you play right now or in 30m or in 1hour")
//   .addField("Right now",":crown:") 
//   .addField("30 Minutes",":hourglass:")
//   .addField("1 Hour",":symbols:")
//   .setFooter(message.author.username,message.author.avatarURL())

//   let msg = await message.channel.send(`Brawlball `, embed).then(msg =>{
//     msg.react("👑")
//     }) 
...
// member.roles.add("974210009065988126");
...
//                 const { message, emoji } = messageReaction;
//                 if(message.channel.id == '828290378695311360' ||message.channel.id == '828289931813847041'){
...
//                       if(user.bot)  return;
//                     else { 
//                   member.roles.remove('974210009065988126')
//                    }})
//                     }}});
...
client.on("message", async message => {
  if (message.content === "!osbb") {
    ...
    const Role1 = message.guild.roles.cache.get("974210009065988126");
    const Role2 = message.guild.roles.cache.get("974210190800994334");
    const Role3 = message.guild.roles.cache.get("974210294584844320");


    const mem = await message.channel.send("yes this")
    ...
    }; mem.awaitReactions(filter, { max: 1, time: 500000, errors: ['time'] })
      .then(collected => {
        setTimeout(function() {
          const reaction = collected.first();

          if (reaction.emoji.name === '📘') {
            message.reply('Get Rdy');
    ...
    mem.awaitReactions(filter2, { max: 1, time: 500000, errors: ['time'] })
      .then(collected => {
        return setTimeout(function() {
          const reaction = collected.first();

          if (reaction.emoji.name === '👑') {
            message.reply('Brawlball Time now');
...
client.on("message", async message => {
  if (message.content === "!os codes") {
    ...
    var embed4 = new Discord.MessageEmbed()
      ...
      .addField("**!htp**", "How to pin messages")
...
client.on("message", async message => {
  if (message.content === "!htp") {
    if (!message.member.hasPermission(["MANAGE_MESSAGES"])) return message.channel.send("You do not have permission to  this")
    var embed4 = new Discord.MessageEmbed()
      .setColor('#8CD7FF')
      .setTitle(`How to pin messages`)
      .setDescription("** Note : You have to use the pin message code in the same channel the message you wanna pin in**")
      .setThumbnail("https://screenshots.gamebanana.com/img/ico/sprays/58f11d50c3c07.png")
      .addField("**_pin ``Paste message to pin id here`` **", " ```to pin message => EX: _pin 970804890395893811```")
      .addField("**_unpin ``Paste message to unpin id here``**", " ```to unpin message => EX: _unpin 970804890395893811```")
      .addField("**!pins**", "```To show normal pinned messages```")
...
client.on("message", async message => {
  ...
  if (cmd === "mk") {
    if (!message.member.roles.cache.some((role) => role.name === "Our Style Members")) return message.channel.send("You do not have permission to  this")
    let autsav = []
    for (let i = 0; i < args.length; i++) { autsav.push(args[i]) }
    autsav = autsav.join(" ")
    client.channels.cache.get("727390897016144012").send(autsav)
...
client.on("message", async message => {
  ...
  if (cmd === "pin") {
    ...
    if (!message.member.roles.cache.some((role) => role.name === "Our Style Members")) return message.channel.send("You do not have permission to  this")
    let pinsav = []
    for (let i = 0; i < args1.length; i++) { pinsav.push(args1[i]) }
    pinsav = pinsav.join(" ")
    client.channels.cache.get("727390897016144012").send(pinsav)

    if (args1.length < 0) return message.reply(`Nothing to say?`).then(m => m.delete(5000));

    if (isNaN(args1[0])) return message.reply("only Numbers and no spaces")
    if (args1[0].length > 20) return message.channel.send("ID is wrong")

    // try {


    // message.channel.messages.fetch(args1[0])

    try {
      await client.guilds.cache.get('535515917518372884').channels.cache.get(message.channel.id).messages.fetch(args1[0]);


    } catch (error) {
      return message.channel.send("Wrong ID")
    }
    ...
    let pinreadjs = fs.readFileSync('pinMessages.json');
    let msgtext = JSON.parse(pinreadjs);

    for (let g = 0; g < msgtext["pinsez"].length; g++) {
      if (args1[0] == msgtext["pinsez"][g]) return message.channel.send("Message already pinned");
    }
    msgtext["pinsez"].push(args1[0]);

    const jsonString = JSON.stringify(msgtext);
    fs.writeFileSync('./pinMessages.json', jsonString)




    let pindatejs = fs.readFileSync('pintime.json');
    let msgdat = JSON.parse(pindatejs);
    msgdat["pindate"].push(Date.now());

    const jsonString2 = JSON.stringify(msgdat);
    fs.writeFileSync('./pintime.json', jsonString2)



    let pinnamejs = fs.readFileSync('pintime.json');
    let msgnam = JSON.parse(pinnamejs);
    msgnam["pinuser"].push(message.author.username);

    const jsonString3 = JSON.stringify(msgnam);
    fs.writeFileSync('./pintime.json', jsonString3)
    ...
    let pinchanjs = fs.readFileSync('pintime.json');
    let msgchan = JSON.parse(pinchanjs);
    msgchan["pinchan"].push(message.channel.id);

    const jsonString4 = JSON.stringify(msgchan);
    fs.writeFileSync('./pintime.json', jsonString4)

    message.channel.send("Message Pinned")
    ...
    let pinreadjs2 = fs.readFileSync('pinMessages.json')
    let msgtext2 = JSON.parse(pinreadjs2)


    let pindatejs4 = fs.readFileSync('pintime.json')
    let msgtime2 = JSON.parse(pindatejs4)


    let f = msgtext2["pinsez"].length - 1

    const namus = msgtime2["pinuser"][f]
    const datez = msgtime2["pindate"][f]

    client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan"][f]).messages.fetch(msgtext2["pinsez"][f])

      .then(messages => {
        const url = messages.url;
        const usertag = messages.author.username;
        const useravat = messages.author.displayAvatarURL();
        let msgcontent;

        if (messages.embeds[0]) {
          if (messages.content == "") msgcontent = messages.embeds[0]
          else msgcontent = messages.content
        }

        else { msgcontent = messages.content; }

        if (messages.attachments.size > 0) {
          const urlss = messages.attachments.first().url;
          let embed = new Discord.MessageEmbed()
            .setAuthor(usertag, useravat, url)
            .setDescription(msgcontent)
            .setImage(urlss)
            .setFooter("Pinned by " + namus)
            .setTimestamp(datez);
          client.channels.cache.get("970773369194704926").send(embed)


        }

        else if (messages.embeds[0]) {
          let embed4 = new Discord.MessageEmbed()
            .setAuthor(usertag, useravat, url)

          client.channels.cache.get("970773369194704926").send(embed4)

          client.channels.cache.get("970773369194704926").send(msgcontent)
          let embed5 = new Discord.MessageEmbed()


            .setFooter("Pinned embed by " + namus)
            .setTimestamp(datez);
          client.channels.cache.get("970773369194704926").send(embed5)
...
client.on('message', async message => {
  if (message.content === '!pins') {
    ...
    for (var i = 0; i < msgtext2["pinsez"].length; i++) {

      let pindatejs = fs.readFileSync('pintime.json')
      let msgtime2 = JSON.parse(pindatejs)

      const namus = msgtime2["pinuser"][i]
      const datez = msgtime2["pindate"][i]
      try {
        await client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan"][i]).messages.fetch(msgtext2["pinsez"][i])
      } catch (error) {

        msgtext2["pinsez"].splice(i, 1);
        msgtime2["pinuser"].splice(i, 1);
        msgtime2["pindate"].splice(i, 1);
        msgtime2["pinchan"].splice(i, 1);




        const jsonString2 = JSON.stringify(msgtext2);
        fs.writeFileSync('./pinMessages.json', jsonString2)
        const jsonString3 = JSON.stringify(msgtime2);
        fs.writeFileSync('./pintime.json', jsonString3)

        return message.channel.send("A pin got deleted now it deleted from the main file")
      }


      pinreadjs2 = fs.readFileSync('pinMessages.json')
      msgtext2 = JSON.parse(pinreadjs2)


      pindatejs = fs.readFileSync('pintime.json')
      msgtime2 = JSON.parse(pindatejs)



      client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan"][i]).messages.fetch(msgtext2["pinsez"][i])
...
client.on("message", async message => {
  ...
  if (cmd === "unpin") {
    ...
    let pinreadjs = fs.readFileSync('pinMessages.json');
    let msgtext3 = JSON.parse(pinreadjs);

    let pindatejs = fs.readFileSync('pintime.json')
    let msgtime4 = JSON.parse(pindatejs)


    for (var i = 0; i < msgtext3["pinsez"].length; i++) {
      if (msgtext3["pinsez"][i] === args1[0]) {
        msgtext3["pinsez"].splice(i, 1);
        msgtime4["pinuser"].splice(i, 1);
        msgtime4["pindate"].splice(i, 1);
        msgtime4["pinchan"].splice(i, 1);
        break;
      }
      else {
        if (i == msgtext3["pinsez"].length - 1) return message.channel.send("Pinned Message ID not found")
      }
    }
    const jsonString2 = JSON.stringify(msgtext3);
    fs.writeFileSync('./pinMessages.json', jsonString2)
    const jsonString4 = JSON.stringify(msgtime4);
    fs.writeFileSync('./pintime.json', jsonString4)



    message.channel.send("**Pin Deleted**")
  }
})
...
client.on("message", async message => {
  ...
  if (cmd === "impin") {
    ...
    let pinreadjs = fs.readFileSync('pinMessages2.json');
    let msgtext = JSON.parse(pinreadjs);

    for (let g = 0; g < msgtext["pinsez2"].length; g++) {
      if (args1[0] == msgtext["pinsez2"][g]) return message.channel.send("Message already pinned");
    }
    msgtext["pinsez2"].push(args1[0]);

    const jsonString = JSON.stringify(msgtext);
    fs.writeFileSync('./pinMessages2.json', jsonString)




    let pindatejs = fs.readFileSync('pintime2.json');
    let msgdat = JSON.parse(pindatejs);
    msgdat["pindate2"].push(Date.now());

    const jsonString2 = JSON.stringify(msgdat);
    fs.writeFileSync('./pintime2.json', jsonString2)



    let pinnamejs = fs.readFileSync('pintime2.json');
    let msgnam = JSON.parse(pinnamejs);
    msgnam["pinuser2"].push(message.author.username);

    const jsonString3 = JSON.stringify(msgnam);
    fs.writeFileSync('./pintime2.json', jsonString3)
    ...
    let pinchanjs = fs.readFileSync('pintime2.json');
    let msgchan = JSON.parse(pinchanjs);
    msgchan["pinchan2"].push(message.channel.id);

    const jsonString4 = JSON.stringify(msgchan);
    fs.writeFileSync('./pintime2.json', jsonString4)

    message.channel.send("Important Message Pinned")
    ...
    let pinreadjs2 = fs.readFileSync('pinMessages2.json')
    let msgtext2 = JSON.parse(pinreadjs2)


    let pindatejs4 = fs.readFileSync('pintime2.json')
    let msgtime2 = JSON.parse(pindatejs4)


    let f = msgtext2["pinsez2"].length - 1

    const namus = msgtime2["pinuser2"][f]
    const datez = msgtime2["pindate2"][f]

    client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan2"][f]).messages.fetch(msgtext2["pinsez2"][f])
      ...
      .then(messages => {
        ...
        if (messages.attachments.size > 0) {
          ...
          let embed = new Discord.MessageEmbed()
            ...
            .setFooter("Pinned by " + namus)
            .setTimestamp(datez);
          client.channels.cache.get("970784332904030208").send(embed)
          ...
          client.channels.cache.get("970784332904030208").send(embed4)

          client.channels.cache.get("970784332904030208").send(msgcontent)
          let embed5 = new Discord.MessageEmbed()


            .setFooter("Pinned embed by " + namus)
            .setTimestamp(datez);
          client.channels.cache.get("970784332904030208").send(embed5)
...
client.on('message', async message => {
  if (message.content === '!impins') {
    ...
    for (var i = 0; i < msgtext2["pinsez2"].length; i++) {

      const namus = msgtime2["pinuser2"][i]
      const datez = msgtime2["pindate2"][i]
      ...
      try {
        await client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan2"][i]).messages.fetch(msgtext2["pinsez2"][i])
      } catch (error) {

        msgtext2["pinsez2"].splice(i, 1);
        msgtime2["pinuser2"].splice(i, 1);
        msgtime2["pindate2"].splice(i, 1);
        msgtime2["pinchan2"].splice(i, 1);




        const jsonString2 = JSON.stringify(msgtext2);
        fs.writeFileSync('./pinMessages2.json', jsonString2)
        const jsonString3 = JSON.stringify(msgtime2);
        fs.writeFileSync('./pintime2.json', jsonString3)
      ...
      pinreadjs2 = fs.readFileSync('pinMessages2.json')
      msgtext2 = JSON.parse(pinreadjs2)


      pindatejs = fs.readFileSync('pintime2.json')
      msgtime2 = JSON.parse(pindatejs)
      ...
      client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan2"][i]).messages.fetch(msgtext2["pinsez2"][i])
...
client.on("message", async message => {
  ...
  if (cmd === "imunpin") {
    ...
    for (var i = 0; i < msgtext3["pinsez2"].length; i++) {
      if (msgtext3["pinsez2"][i] === args1[0]) {
        msgtext3["pinsez2"].splice(i, 1);
        msgtime4["pinuser2"].splice(i, 1);
        msgtime4["pindate2"].splice(i, 1);
        msgtime4["pinchan2"].splice(i, 1);
        break;
      }
      else {
        if (i == msgtext3["pinsez2"].length - 1) return message.channel.send("Pinned Message ID not found")
      }
    }
    const jsonString2 = JSON.stringify(msgtext3);
    fs.writeFileSync('./pinMessages2.json', jsonString2)
...
client.on('message', async message => {
  if (message.content === '!lsp') {
    ...
    let q = msgtext2["pinsez2"].length - 1;

    const namus = msgtime2["pinuser2"][q]
    const datez = msgtime2["pindate2"][q]
    ...
    try {
      await client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan2"][q]).messages.fetch(msgtext2["pinsez2"][q])
    } catch (error) {

      msgtext2["pinsez2"].splice(q, 1);
      msgtime2["pinuser2"].splice(q, 1);
      msgtime2["pindate2"].splice(q, 1);
      msgtime2["pinchan2"].splice(q, 1);
      ...
      return message.channel.send("the last pin got deleted from messages now it deleted from the main file try the code again")
    }
    ...
    client.guilds.cache.get('535515917518372884').channels.cache.get(msgtime2["pinchan2"][q]).messages.fetch(msgtext2["pinsez2"][q])
